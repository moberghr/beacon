...
internal sealed class ApplyDocumentationPatchHandler(IDbContextFactory<SemanticoContext> contextFactory)
    : IRequestHandler<ApplyDocumentationPatchCommand>
{
    ...
    private static async Task ApplyColumnDescriptionAsync(SemanticoContext context, Data.Entities.McpDocumentationPatch patch, CancellationToken ct)
    {
    ...
    private static async Task ApplyTableDescriptionAsync(SemanticoContext context, Data.Entities.McpDocumentationPatch patch, CancellationToken ct)
    {
    ...
    private static async Task ApplyDocumentationSectionAsync(SemanticoContext context, Data.Entities.McpDocumentationPatch patch, CancellationToken ct)
    {
