...
namespace Semantico.Core.Handlers.Dashboards.GetDashboardPermissions;

internal sealed class GetDashboardPermissionsHandler(
    IDbContextFactory<SemanticoContext> contextFactory) : IRequestHandler<GetDashboardPermissionsQuery, List<DashboardPermissionData>>
{
