...
namespace Semantico.Core.Handlers.DataQuality.GetDataContracts;

internal sealed class GetDataContractsHandler(
    IDbContextFactory<SemanticoContext> contextFactory) : IRequestHandler<GetDataContractsQuery, List<DataContractData>>
{
