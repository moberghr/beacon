...
public class AiActorService : IAiActorServiceExtended
{
    ...
    public async Task<Semantico.Core.Data.Entities.AiActor> CreateActorAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var actor = new Semantico.Core.Data.Entities.AiActor
        {
            Name = options.Name,
    ...
    public async Task<Semantico.Core.Data.Entities.AiActor?> GetActorAsync(
        int actorId,
        CancellationToken cancellationToken = default)
    {
        await using var context = await _contextFactory.CreateDbContextAsync(cancellationToken);
    ...
    public async Task<List<Semantico.Core.Data.Entities.AiActor>> GetActorsForDataSourceAsync(
        int dataSourceId,
    ...
    private async Task<AiActorAction> ExecuteActionAsync(
        Semantico.Core.Data.Entities.AiActor actor,
