...
public class BedrockProvider : ILlmProvider
{
    ...
    public async Task<Semantico.Core.Models.Ai.LlmResponse> CompleteAsync(LlmRequest request, CancellationToken cancellationToken = default)
    {
        if (_client == null)
    ...
    private async Task<Semantico.Core.Models.Ai.LlmResponse> InvokeClaudeModelAsync(LlmRequest request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            {
                role = m.Role == Semantico.Core.Data.Enums.ConversationRole.User ? "user" : "assistant",
                content = m.Content
            }).ToList();
            ...
            return new Semantico.Core.Models.Ai.LlmResponse
            {
                Content = content,
    ...
    private async Task<Semantico.Core.Models.Ai.LlmResponse> InvokeLlamaModelAsync(LlmRequest request, CancellationToken cancellationToken)
    {
        ...
        {
            var role = message.Role == Semantico.Core.Data.Enums.ConversationRole.User ? "user" : "assistant";
