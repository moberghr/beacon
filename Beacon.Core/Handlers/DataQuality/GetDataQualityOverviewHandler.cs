...
namespace Beacon.Core.Handlers.DataQuality.GetDataQualityOverview;

internal sealed class GetDataQualityOverviewHandler(
    IDbContextFactory<BeaconContext> contextFactory) : IRequestHandler<GetDataQualityOverviewQuery, List<DataQualityOverviewData>>
{
