...
/// </summary>
internal sealed class DefaultAuthenticationProvider : IBeaconAuthenticationProvider
{
        ...
        CancellationToken cancellationToken = default)
    {
        return Task.FromResult(AuthenticationResult.Failed(
            "Authentication is not configured. Please implement IBeaconAuthenticationProvider."));
    }
