...
/// <summary>
/// Represents a user in the Beacon system.
/// Supports both internal users (password stored in Beacon) and external users (authenticated via JWT/OAuth).
/// </summary>
public class BeaconUser : ArchivableBaseEntity
{
    /// <summary>
    ...
    /// <summary>
    /// True if this user authenticates with a password stored in Beacon.
