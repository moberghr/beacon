...
namespace Beacon.Core.PostgreSql.Data.Migrations
{
    ...
    [Migration("20260922121032_MoveTablesToConfiguredSchema")]
    partial class MoveTablesToConfiguredSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.McpDocChunk", b =>
                {
                    ...
                    b.Property<string>("ContextualBlurb")
                        .HasColumnType("text")
                        .HasColumnName("contextual_blurb");
                    ...
                    b.HasIndex("ProjectId", "SourceSectionId")
                        .HasDatabaseName("ix_mcp_doc_chunks_project_id_source_section_id");

                    b.ToTable("mcp_doc_chunks", "beacon");
                });
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.McpEvalCase", b =>
                {
                    ...
                    b.ToTable("mcp_eval_cases", "beacon");
                });
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.McpEvalResult", b =>
                {
                    ...
                    b.ToTable("mcp_eval_results", "beacon");
                });
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.McpEvalRun", b =>
                {
                    ...
                    b.ToTable("mcp_eval_runs", "beacon");
                });

            modelBuilder.Entity("Beacon.Core.Data.Entities.McpGlossaryTerm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("MetricExpression")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_mcp_glossary_terms");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_mcp_glossary_terms_project_id");

                    b.HasIndex("ProjectId", "IsActive")
                        .HasDatabaseName("ix_mcp_glossary_terms_project_id_is_active");

                    b.ToTable("mcp_glossary_terms", "beacon");
                });
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.McpProjectSettings", b =>
                {
                    ...
                    b.ToTable("mcp_project_settings", "beacon");
                });
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.Metadata.ColumnMetadata", b =>
                {
                    ...
                    b.Property<string>("ForeignKeyConstraintName")
                        ...
                        .HasColumnName("foreign_key_constraint_name");

                    b.Property<string>("ForeignKeySchema")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("foreign_key_schema");
                    ...
                    b.Property<bool>("SampleValuesComplete")
                        .HasColumnType("boolean")
                        .HasColumnName("sample_values_complete");
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.Metadata.SchemaRelationship", b =>
                {
                    ...
                    b.ToTable("schema_relationships", "beacon");
                });
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.QueryExecutionHistory", b =>
                {
                    ...
                    b.HasIndex("CreatedTime")
                        .HasDatabaseName("ix_query_execution_history_created_time");

                    b.HasIndex("NotificationStatus", "CreatedTime")
                        .HasDatabaseName("ix_query_execution_history_notification_status_created_time");

                    b.HasIndex("SubscriptionId", "CreatedTime")
                        .HasDatabaseName("ix_query_execution_history_subscription_id_created_time");
            ...
            modelBuilder.Entity("Beacon.Core.Data.Entities.TaskWatcher", b =>
                {
                    ...
                    b.ToTable("task_watchers", "beacon");
                });
