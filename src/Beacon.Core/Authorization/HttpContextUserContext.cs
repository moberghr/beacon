...
/// </summary>
internal sealed class HttpContextUserContext : IBeaconUserContext
{
    ...
    public string? UserId =>
        _httpContextAccessor.HttpContext?.User.FindFirst(BeaconClaims.UserId)?.Value
        ?? _httpContextAccessor.HttpContext?.User.FindFirst(ClaimTypes.NameIdentifier)?.Value;

    public string? UserName =>
        _httpContextAccessor.HttpContext?.User.FindFirst(BeaconClaims.UserName)?.Value
