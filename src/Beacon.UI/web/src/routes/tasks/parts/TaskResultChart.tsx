  ...
  return (
    <Card>
      <CardHead>
        ...
        <CardTitle>Result count progression</CardTitle>
        <CardSub>per execution</CardSub>
      </CardHead>
      <CardBody className="px-4 py-2">
        {points.length < 2
          ? <ChartEmpty />
          : <Chart points={points} />}
        <div className="flex items-center gap-3 mt-1 pl-1 text-xs">
          <span className="inline-flex items-center gap-1.5">
            <span className="size-2.5 rounded-xs bg-brand-500" />Result count
          </span>
          <span className="inline-flex items-center gap-1.5">
            <span className="size-2.5 rounded-xs bg-warn opacity-50" />Threshold
          </span>
          <span className="text-text-muted ml-auto text-xs mono">
...
function ChartEmpty() {
  return (
    <div className="text-text-muted text-center py-10 px-3 text-xs">
