...
namespace Beacon.MCP.Resources;
...
{
    [McpServerResource(UriTemplate = "beacon://project/{projectId}/documentation",
    ...
    public async Task<string> ReadDocumentationAsync(int projectId, CancellationToken cancellationToken = default)
    {
        ...
        return markdown ?? "No documentation generated yet. Use the Beacon UI to generate project documentation.";
    }

    [McpServerResource(UriTemplate = "beacon://project/{projectId}/schema",
    ...
    [McpServerResource(UriTemplate = "beacon://project/{projectId}/quality",
    ...
    public async Task<string> ReadQualityAsync(int projectId, CancellationToken cancellationToken = default)
    {
        ...
        if (scores.Count == 0)
        {
            sb.AppendLine("No data quality scores. Set up Data Contracts in the Beacon UI.");
        }
        else
        {
    ...
    [McpServerResource(UriTemplate = "beacon://project/{projectId}/report",
