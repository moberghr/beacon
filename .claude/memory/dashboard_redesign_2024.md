...
1. **src/Beacon.Core/Models/QueryExecutionHistory/QueryStatisticsModels.cs**
   - Added `RecentActivityItem`, `TopSubscriptionItem` models
   - Enhanced `DashboardStatisticsData` with new properties

2. **src/Beacon.Core/Services/StatisticsService.cs**
...
3. **src/Beacon.UI/Components/Pages/Home.razor**
