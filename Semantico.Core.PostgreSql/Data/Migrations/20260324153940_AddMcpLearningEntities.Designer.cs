...
namespace Semantico.Core.PostgreSql.Data.Migrations
{
    ...
    [Migration("20260324153940_AddMcpLearningEntities")]
    partial class AddMcpLearningEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.DataProtection.EntityFrameworkCore.DataProtectionKey", b =>
                {
                    ...
                    b.ToTable("data_protection_keys", "semantico");
                });
            ...
            modelBuilder.Entity("Semantico.Core.Data.Entities.DataQuality.DataContract", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("data_contracts", "semantico");
                });

            modelBuilder.Entity("Semantico.Core.Data.Entities.DataQuality.DataContractRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("data_contract_rules", "semantico");
                });

            modelBuilder.Entity("Semantico.Core.Data.Entities.DataQuality.DataQualityEvaluation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("data_quality_evaluations", "semantico");
                });

            modelBuilder.Entity("Semantico.Core.Data.Entities.DataQuality.DataQualityRuleResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("data_quality_rule_results", "semantico");
                });

            modelBuilder.Entity("Semantico.Core.Data.Entities.DataQuality.DataQualityScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("data_quality_scores", "semantico");
                });
            ...
            modelBuilder.Entity("Semantico.Core.Data.Entities.Projects.ProjectDocumentation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("project_documentations", "semantico");
                });

            modelBuilder.Entity("Semantico.Core.Data.Entities.Projects.ProjectDocumentationSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("project_documentation_sections", "semantico");
                });
            ...
            modelBuilder.Entity("Semantico.Core.Data.Entities.DataQuality.DataContractRule", b =>
                {
                    b.HasOne("Semantico.Core.Data.Entities.DataQuality.DataContract", "DataContract")
                        .WithMany("Rules")
            ...
            modelBuilder.Entity("Semantico.Core.Data.Entities.DataQuality.DataQualityRuleResult", b =>
                {
                    b.HasOne("Semantico.Core.Data.Entities.DataQuality.DataContractRule", "DataContractRule")
                        .WithMany()
                    ...
                    b.HasOne("Semantico.Core.Data.Entities.DataQuality.DataQualityEvaluation", "DataQualityEvaluation")
            ...
            modelBuilder.Entity("Semantico.Core.Data.Entities.Projects.ProjectDocumentationSection", b =>
                {
                    b.HasOne("Semantico.Core.Data.Entities.Projects.ProjectDocumentation", "Documentation")
                        .WithMany("Sections")
