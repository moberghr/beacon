...
/// </summary>
public class SemanticoAuthenticationService : ISemanticoAuthenticationService
{
    private readonly ISemanticoAuthenticationProvider _authenticationProvider;
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly SemanticoConfiguration _configuration;

    public SemanticoAuthenticationService(
        ISemanticoAuthenticationProvider authenticationProvider,
