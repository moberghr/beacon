...
internal sealed class NullAiActorService : IAiActorService
{
    ...
    public Task<Beacon.Core.Data.Entities.AiActor> CreateActorAsync(
    ...
    public Task<Beacon.Core.Data.Entities.AiActor?> GetActorAsync(
        int actorId,
        CancellationToken cancellationToken = default)
    {
        return Task.FromResult<Beacon.Core.Data.Entities.AiActor?>(null);
    }

    public Task<List<Beacon.Core.Data.Entities.AiActor>> GetActorsForDataSourceAsync(
        int dataSourceId,
        bool includeArchived = false,
        CancellationToken cancellationToken = default)
    {
        return Task.FromResult(new List<Beacon.Core.Data.Entities.AiActor>());
    }
