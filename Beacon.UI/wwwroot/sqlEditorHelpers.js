            ...
            const disposable = monaco.languages.registerCompletionItemProvider('sql', {
                ...
                provideCompletionItems: (model, position) => {
                    try {
                        ...
                        let editor = window.beaconSqlEditor.editorInstances[editorId];
                        ...
                        if (!editor && window.monaco && window.monaco.editor) {
                             ...
                             if (editor) {
                                 window.beaconSqlEditor.editorInstances[editorId] = editor;
                             }
                        }
                        ...
                        // Analyze context
                        const context = window.beaconSqlEditor.analyzeContext(textUntilPosition, fullText, metadata);
